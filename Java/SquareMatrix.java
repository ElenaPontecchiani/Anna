...
public SquareMatrix(int dim){
		super(dim,dim);}//chiamata costruttore matrix(int,int)
/*		
public SquareMatrix copy(matrix<T> m){
		copy(m);//tenere this, corretto?
inutile:hanno stesso comportamento????????????	}*/
...
/*
public void fun1()throws IndiceNonCorretto{
