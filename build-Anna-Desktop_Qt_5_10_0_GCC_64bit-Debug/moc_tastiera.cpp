...
void Tastiera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tastiera::trasposta)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Tastiera::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tastiera::gauss)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Tastiera::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tastiera::gaussj)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tastiera::radX)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (Tastiera::*_t)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tastiera::powX)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (Tastiera::*_t)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tastiera::plusX)) {
                *result = 5;
                return;
            }
        }
